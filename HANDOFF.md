...
## 2. 現状（2026-09-14 時点・未コミット／Git 未初期化）
...
- [ ] **いっちゃん判断**: GitHub のオーナー（三好さん側で作る / Icchaso で作って移管 / Organization）
- [ ] GitHub 化の前に「ツール本体」と「実データ」を分ける（.gitignore で 01_clients 実データ・00_inbox・04_logs を除外、または実運用 vault を別フォルダに複製する方式）
